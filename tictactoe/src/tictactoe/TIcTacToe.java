...
public class TIcTacToe {
	...
	private void winningGame() {
		if(b1==1 && b2==1 && b3==1) {
			...
			xCount1++;			
			countX.setText(String.valueOf(xCount1));
		}
...
// for o
			...
			oCount1++;			
			countO.setText(String.valueOf(oCount1));
		}
	...
	private void initialize() {
		...
		btn1.setFont(new Font("Tahoma", Font.BOLD, 39));
		...
		btn2.setFont(new Font("Tahoma", Font.BOLD, 39));
		...
		btn3.setFont(new Font("Tahoma", Font.BOLD, 39));
		...
		btnplayerx.setFont(new Font("Tahoma", Font.BOLD, 19));
		...
		countX = new JTextField();
		countX.setHorizontalAlignment(SwingConstants.CENTER);
		countX.setText("0");
		countX.setFont(new Font("Tahoma", Font.BOLD, 39));
		panel_5.add(countX, BorderLayout.CENTER);
		countX.setColumns(10);
		...
		btn4.setFont(new Font("Tahoma", Font.BOLD, 39));
		...
		btn5.setFont(new Font("Tahoma", Font.BOLD, 39));
		...
		btn6.setFont(new Font("Tahoma", Font.BOLD, 39));
		...
		btnplayero.setFont(new Font("Tahoma", Font.BOLD, 18));
		panel_9.add(btnplayero, BorderLayout.CENTER);
		...
		countO = new JTextField();
		countO.setText("0");
		countO.setHorizontalAlignment(SwingConstants.CENTER);
		countO.setFont(new Font("Tahoma", Font.BOLD, 39));
		panel_10.add(countO, BorderLayout.CENTER);
		countO.setColumns(10);
		...
		btn7.setFont(new Font("Tahoma", Font.BOLD, 39));
		...
		btn8.setFont(new Font("Tahoma", Font.BOLD, 39));
		...
		btn9.setFont(new Font("Tahoma", Font.BOLD, 39));
